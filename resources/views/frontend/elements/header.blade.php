...
<head>
  ...
  {{--  fs Style --}}
    <link href="{{asset('custom_style.css')}}" rel="stylesheet">
    <!--[if lt IE 9]>
                ...
                <div class="col-sm-4">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> 01797-506292</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> info@eshopper.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-4"><h4>This site not complite, working on</h4></div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{ url::to('/checkLoginShipping') }}"><i class="fa fa-crosshairs"></i> Checkout</a></li>

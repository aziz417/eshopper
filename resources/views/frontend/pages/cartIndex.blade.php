            ...
            <table class="table table-condensed">
                ...
                <tr>
                    <td class="cart_product">
                        <a href=""><img src="{{url('frontend/images/cart/three.png')}}" alt=""></a>
                    </td>
                    ...
                    <td class="cart_quantity">
                        <div class="cart_quantity_button">
                            <form action="{{ route( 'cart.update' )}}" method="post">
                                ...
                                <input class="cart_quantity_input" style="width: 100px!important;" type="number" name="qty" value="{{$data->qty}}" >
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="total_area">
                    ...
                    <a class="btn btn-default check_out" href="{{url::to('/checkLoginShipping')}}">Check Out</a>
                </div>
            </div>
        </div>
    </div>

        ...
        <div class="box black span4" onTablet="span6" onDesktop="span4">
            ...
            <div class="box-content">
                <ul class="dashboard-list metro">
                    <li class="green">
                        <a href="#">
                            <img class="avatar" alt="Lucas" src="{{asset('admin/img/avatar.jpg')}}">
                        </a>
                    ...
                    <li class="yellow">
                        <a href="#">
                            <img class="avatar" alt="Bill" src="{{asset('admin/img/avatar9.jpg')}}">
                        </a>
                    ...
                    <li class="red">
                        <a href="#">
                            <img class="avatar" alt="Jane" src="{{asset('admin/img/avatar5.jpg')}}">
                        </a>
                    ...
                    <li class="blue">
                        <a href="#">
                            <img class="avatar" alt="Kate" src="{{asset('admin/img/avatar6.jpg')}}">
                        </a>
